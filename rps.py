...
#日期可以根据需要自己改动
def get_data(code,start='20200419', end='20210420'):
...
print(df_new[df_new["trade_date"] == "2021-04-20"]["中国出版"].head())
exit(0)
def plot_rps(stock):
    plt.subplot(211)
    ...
    my_ticks = pd.date_range('2021-4-1','2021-4-21',freq='m')
